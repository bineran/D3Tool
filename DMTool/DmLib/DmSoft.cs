...
namespace DMTool.DmLib2
{
    ...
    public class DmSoft : IDisposable
    {
        ...
        URCOMLoader _urCom;
        public Idmsoft DM { get;private set; }
        string _dmPath;
        string dmpath = AppDomain.CurrentDomain.BaseDirectory + @"Dll\dm.dll";
        ...
        public DmSoft()
        {
            ...
            DM = _urCom.CreateObjectFromPath(dmpath, Guid.Parse("26037A0E-7CBD-4FFF-9C63-56F2D0770214"), false) as Idmsoft;
        }
